	...
	while($b=mysql_fetch_array($mhs)){
		...
		<tr>
			...
			<td>
				...
				<a href="edit_batch.php?kd_batch=<?php echo $b['kd_batch']; ?>" class="btn btn-warning">Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus.php?kd_batch=<?php echo $b['kd_batch']; ?>' }" class="btn btn-danger">Hapus</a>
			</td>
		</tr>		
		<?php 
	}
